...
function Insights({ go }) {
  ...
  return (
    <div className="page">
      <PageHero
        eyebrow="INSIGHTS"
        h1={<>Thinking Ahead, So Africa <span style={{ color: 'var(--mint)' }}>Doesn't Fall Behind.</span></>}
        sub="Articles, guides, reports, and resources that are genuinely useful — not content for content's sake." />
...
function About({ go }) {
  return (
    <div className="page">
      ...
      <section className="section dark">
        <div className="wrap" style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 0.5fr) minmax(0, 1fr)', gap: 64, alignItems: 'start' }} className="grid-stack">
          <div>
          ...
          <div style={{ paddingTop: '52px' }}>
            ...
            <p className="body" style={{ fontSize: 15, lineHeight: 1.7, marginTop: 0 }}>
      ...
      <section className="section deep">
        <div className="wrap" style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1fr) minmax(0,1fr)', gap: 32 }} className="grid-stack">
