...
function WhatWeDo({ go }) {
  return (
    <div className="page">
      {/* Custom hero — NEXT OS impact image is the visual; title hidden per design choice */}
      <section style={{ position: 'relative', overflow: 'hidden', padding: '120px 0 80px' }}>
        <div className="grid-bg" style={{ position: 'absolute', inset: 0, opacity: 0.4 }} />
        <div style={{ position: 'absolute', top: '-20%', left: '50%', transform: 'translateX(-50%)', width: 800, height: 600, background: 'radial-gradient(ellipse, rgba(0,252,143,0.14), transparent 60%)', filter: 'blur(60px)' }} />
        <div className="wrap" style={{ position: 'relative', maxWidth: 1100 }}>
          ...
          <div style={{ borderRadius: 20, overflow: 'hidden', marginBottom: 32, boxShadow: '0 30px 80px -20px rgba(0,0,0,0.6), 0 0 0 1px rgba(0,252,143,0.18)' }}>
            <img loading="lazy" decoding="async" src="assets/next-os-impact.jpg" alt="NEXT OS transforming African medical, schools, governments, homes, companies, NGOs" style={{ display: 'block', width: '100%', height: 'auto' }} />
          </div>
  ...
  return (
    <div className="page">
      <PageHero
        ...
        h1={<>We Understand Your World.<br/><span style={{ color: 'var(--mint)' }}>Because We Were Built for It.</span></>}
        sub="When a school principal, NGO director, or church leader lands here, they should immediately feel understood. That feeling is the beginning of trust."
      />
